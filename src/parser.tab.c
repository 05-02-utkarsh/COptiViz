...
yyreduce:
  ...
  switch (yyn)
    {
  case 2: /* stmt: IDENTIFIER '=' expr ';'  */
#line 31 "parser.y"
                                { ast_root = make_assign_node((yyvsp[-3].str), (yyvsp[-1].node)); }
